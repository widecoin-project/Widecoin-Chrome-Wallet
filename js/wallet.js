...
var wcnqrcode = new QRCode(document.getElementById("wcnqr"), {
    width: 100,
    height: 100,
    position: "center"
})
    ...
    function checkAPI() {
        apiCall().then(function(data) {
            if (data.error == null) {
                ...
                $("#currentBalance").text("Enter a valid Widecoin address")
...
function qrcodegen() {
    if (!document.getElementById("addressInput").value) {
        wcnqrcode.makeCode("Enter an address")
    }
    else {
        wcnqrcode.makeCode(document.getElementById("addressInput").value)
    }
}
